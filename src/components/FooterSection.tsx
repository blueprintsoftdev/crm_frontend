        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-white/50 text-sm leading-relaxed max-w-sm">
              We are a design house dedicated to the art of Indian textile. Our
              mission is to keep the loom alive while dressing the future.
            </p>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-[1400px] mx-auto px-4 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center text-xs text-white/30">
            <p>© 2026 Blueprint CRM Inc. All rights reserved.</p>
